...
void setup(){
  ...
  while(eeprom_data[33] != 'J' || eeprom_data[34] != 'M' || eeprom_data[35] != 'B'){
    ...
    digitalWrite(12, !digitalRead(12));     // led status function                                            //Change the led status to indicate error.
  }
...
void loop(){
  ...
  if(data == 'r'){
    ...
    esc_1 = 1000;                                                                       //Set the pulse for ESC 1 to 1000
    esc_2 = 1000;                                                                       //Set the pulse for ESC 1 to 1000
    esc_3 = 1000;                                                                       //Set the pulse for ESC 1 to 1000
    esc_4 = 1000;                                                                       //Set the pulse for ESC 1 to 1000
    esc_pulse_output();                                                                 //Send the ESC control pulses.
  }
...
void wait_for_receiver(){
  ...
  while(zero < 15){
    receiver_data();//Stay in this loop until the 4 lowest bits are set
